    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="text-center bg-blue-100 py-12 rounded-lg">
        ...
        <Button
          asChild
          size="lg"
          className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 group relative overflow-hidden"
        >
          <Link href="/free-search">
            ...
            <span className="absolute inset-0 flex items-center justify-center bg-blue-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
